...
import { PostTeacherRequestBodyType } from '~/types/teachers/teacherType'
import { useGetTeacherStatusesQuery } from '~/stores/server/teacher/teacherStatusStore'
import { usePostTeacherMutation } from '~/stores/server/teacher/teacherStore'
// import { usePostStudentParentMutation } from '~/stores/server/student/studentParentStore'

type FormType = PostTeacherRequestBodyType

const FORM_INITIAL_VALUES: PostTeacherRequestBodyType = {
    name: '',
    avatar: '',
    email: '',
    phone: '',
...
const TeacherCreationPage = () => {
    ...
    const postTeacherMutation = usePostTeacherMutation()
    ...
    const handleSubmit = async () => {
        try {
            ...
            const requestBody: FormType = {
                ...
                differentPhone: formValues.differentPhone,
                dob: formValues.dob,
                elo: formValues.elo,
    ...
    //   Effects
    useEffect(() => {
        console.log(getBranchesQuery.data)
    ...
    return (
        <div className='flex flex-col items-start'>
            ...
            <Button
                type='primary'
                className='self-end'
                loading={postTeacherMutation.isPending}
                onClick={() => form.submit()}
            >
                Hoàn thành
            </Button>
